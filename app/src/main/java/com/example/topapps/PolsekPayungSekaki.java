...
public class PolsekPayungSekaki extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                String nomortel ="tel:0761-272140";
            ...
            {
                String lokasikp ="https://maps.app.goo.gl/u9U8b89G1p6Whq5A9";
                a= new Intent(Intent.ACTION_VIEW,Uri.parse(lokasikp));

            }else if (pilihan.equals("Website"))
            {
                String website ="http://humas.polri.go.id";
