...
public class SmpDY extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            {
                String lokasisp ="https://maps.app.goo.gl/kPd9tLXiUAYUqXZU8";
                a= new Intent(Intent.ACTION_VIEW,Uri.parse(lokasisp));

            }else if (pilihan.equals("Website"))
            {
                String website ="http://darmayudha.com";
                a = new Intent(Intent.ACTION_VIEW,Uri.parse(website));
            }else if (pilihan.equals("Info di Google"))
            {
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY,"SMP Darma Yudha");
            }
